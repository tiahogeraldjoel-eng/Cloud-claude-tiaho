...
object NetworkModule {
    ...
    fun provideOkHttpClient(): OkHttpClient {
        ...
        return OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                // User-Agent pour le scraping BRVM
                val request = chain.request().newBuilder()
                    .header("User-Agent", "Mozilla/5.0 (Android; BRVM Intelligence/${BuildConfig.APP_VERSION})")
    ...
    @Provides
    @Singleton
    fun provideBRVMScraper(): BRVMScraper = BRVMScraper()
}
