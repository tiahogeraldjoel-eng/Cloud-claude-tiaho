...
const USER_PORTFOLIO = [
  { symbol: 'UNXC',  qty:   75, avgCost:  1_918 },
  { symbol: 'SNTS',  qty:  100, avgCost: 30_108 },
  { symbol: 'BOAB',  qty:  100, avgCost:  7_537 },
  { symbol: 'SDSC',  qty:   55, avgCost:  2_854 },
  { symbol: 'BOAC',  qty:  131, avgCost:  7_712 },
  { symbol: 'BOABF', qty:   66, avgCost:  5_053 },
  { symbol: 'SIBC',  qty:   42, avgCost:  6_596 },
  { symbol: 'CBIBF', qty:   86, avgCost: 19_703 },
  { symbol: 'NSBC',  qty:   34, avgCost: 10_978 },
...
const KNOWN_STOCKS = {
  ...
  BICB:  { name: 'BIIC Bénin',                           avgVol:   200, refPrice:  7_085,  liq:'L' },
  BNBC:  { name: 'Bernabé CI',                    avgVol:  4650, refPrice:  1700,  liq:'M' },
  BOAB:  { name: 'Bank of Africa Bénin',          avgVol:   980, refPrice:  8_695,  liq:'M' },
  BOABF: { name: 'Bank of Africa Burkina Faso',   avgVol:   180, refPrice:  7_150,  liq:'L' },
  BOAC:  { name: "Bank of Africa Côte d'Ivoire",  avgVol:  2800, refPrice: 10_000,  liq:'M' },
  ...
  CBIBF: { name: 'Coris Bank International BF',   avgVol:   580, refPrice: 26_450,  liq:'M' },
  CFAC:  { name: 'CFAO Motors CI',                avgVol:   580, refPrice:  4800,  liq:'M' },
  ECOC:  { name: "Ecobank Côte d'Ivoire",         avgVol:   650, refPrice: 15_900,  liq:'M' },
  ETIT:  { name: 'Ecobank Transnational (ETI)',   avgVol: 98000, refPrice:     33,  liq:'H' },
  NEIC:  { name: 'NEI-CEDA CI',                   avgVol:   800, refPrice:   620,  liq:'M' },
  NSBC:  { name: 'NSIA Banque CI',                avgVol:   950, refPrice: 23_000,  liq:'M' },
  ...
  SDSC:  { name: 'AGL CI — Africa Global Logistics (ex-Bolloré)', avgVol: 1200, refPrice:  2_770,  liq:'M' },
  ...
  SIBC:  { name: 'SIB CI',                        avgVol:  1400, refPrice:  8_650,  liq:'M' },
  SICC:  { name: 'SICOR CI',                      avgVol:   220, refPrice:  3800,  liq:'L' },
  SIPH:  { name: "SIPH CI Plantations d'Hévéas", avgVol:   290, refPrice:  8900,  liq:'L' },
  SIVC:  { name: "Erium Côte d'Ivoire (ex-Air Liquide CI)", avgVol: 240, refPrice:  2_335,  liq:'L' },
  SLBC:  { name: 'Solibra CI',                    avgVol:    30, refPrice:120000,  liq:'L' },
  SMBC:  { name: 'SMB CI',                        avgVol:   120, refPrice: 17_700,  liq:'L' },
  SNTS:  { name: 'Sonatel (Orange Sénégal)',      avgVol:  3800, refPrice: 31_800,  liq:'M' },
...
async function handleTelegramCommand(update, env) {
  try {
    ...
    if (cmd === 'buy') {
      ...
      await reply([
        '📖 *BRVM Analytics — Guide rapide*',
        '━━━━━━━━━━━━━━━━━━━━━',
        '',
        '📊 *Suivi de portefeuille*',
        '`/portfolio` ou `/p` — P&L live de toutes tes positions',
        '`/export` — fichier CSV à télécharger',
        `🔗 Vue web : ${WORKER_URL}/portfolio`,
        '',
        '🛒 *Enregistrer une opération*',
        '`/buy NSBC 5 20244` — achat (ou renforcement, recalcule le CMP)',
        '`/sell NSBC 5` — vente partielle ou totale',
        '',
        '🔧 *Corrections*',
        '`/fix NSBC 32 10167` — corriger directement quantité et CMP sans recalcul',
        '`/reset CONFIRM` — tout réinitialiser depuis la référence du bot',
        '',
        '🔍 *Avant de passer un ordre*',
        '`/carnet NSBC` — pression acheteurs/vendeurs sur un titre',
        '',
        '⏰ *Alertes automatiques*',
        '_10h15 → signaux post-fixing (MPR/OBI/Iceberg)_',
        '_13h30 → surveillance des stops_',
        '_15h30 → bilan de clôture + P&L du jour_',
      ].join('\n'));
    }
  } catch (e) {
